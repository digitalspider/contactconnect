...
public class LinkedInConnection extends BaseContactInterfacePresent<LinkedInApiClient,Person> implements ContactConnection<LinkedInApiClient,Person> {
	 ...
	 * 
	 */
	public LinkedInConnection(BaseContactInterface<LinkedInApiClient,Person> contactInterface) {
	...
	public LinkedInApiClient getConnection() throws ConnectionException {
		try {
			...
			linkedInApiClient = linkedInApiClientFactory.createLinkedInApiClient(token.getToken(),"");
			return linkedInApiClient;
