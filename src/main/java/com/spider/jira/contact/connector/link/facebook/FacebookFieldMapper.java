...
public class FacebookFieldMapper extends BaseContactInterfacePresent<FacebookClient,User> implements ContactFieldMapper<FacebookClient,User>, ConnectorConstants {

	public FacebookFieldMapper(BaseContactInterface<FacebookClient,User> contactInterface) {
